...
using static LinqLamba.LinqDataTable;
...
namespace LinqLamba
{
    public class ProjectionOperators
    {
        ...
        { 
            ...
            samples.DataSetLinqLamda13();
            samples.DataSetLinqLamda14();
            samples.DataSetLinqLamda15();
            samples.DataSetLinqLamda16();
            samples.DataSetLinqLamda17();
            samples.DataSetLinqLamda18();
            samples.DataSetLinqLamda19();
        }
        ...
        private class LinqSamples
        {
            ...
            public void DataSetLinqLamda13()
            {

                var numbers = testDS.Tables["Numbers"].AsEnumerable();
                var digits = testDS.Tables["Digits"];

                var lowNums = numbers.Where(n => n.Field<int>("number") < 5).Select(n => digits.Rows[n.Field<int>("number")].Field<string>("digit"));
            ...
            public void DataSetLinqLamda14()
            {
                ...
                var pairs = numbersA.SelectMany(a => numbersB, (a, b) => new { a, b })
                        .Where(@t => @t.a.Field<int>("number") < @t.b.Field<int>("number"))
                        .Select(@t => new { a = @t.a.Field<int>("number"), b = @t.b.Field<int>("number") });
            ...
            public void DataSetLinqLamda15()
            {
                ...
                var smallOrders =
                    customers.SelectMany(c => orders, (c, o) => new { c, o })
                        .Where(@t => @t.c.Field<string>("CustomerID") == @t.o.Field<string>("CustomerID") && @t.o.Field<decimal>("Total") < 500.00M)
                        .Select(@t => new {
                            CustomerID = @t.c.Field<string>("CustomerID"),
                            OrderID = @t.o.Field<int>("OrderID"),
                            Total = @t.o.Field<decimal>("Total")
                        });
                ObjectDumper.Write(smallOrders);
            }
            ...
            public void DataSetLinqLamda16()
            {
                ...
                var myOrders =
                    customers.SelectMany(c => orders, (c, o) => new { c, o }).
                    Where(@t => @t.c.Field<string>("CustomerID") == @t.o.Field<string>("CustomerID") && @t.o.Field<DateTime>("OrderDate") >= new DateTime(1998, 1, 1)).
                    Select(@t => new {
                        CustomerID = @t.c.Field<string>("CustomerID"),
                        OrderID = @t.o.Field<int>("OrderID"),
                        OrderDate = @t.o.Field<DateTime>("OrderDate")
                    });
                ObjectDumper.Write(myOrders);
            }
            ...
            public void DataSetLinqLamda17()
            {
                ...
                var myOrders =
                    customers.SelectMany(c => orders, (c, o) => new { c, o })
                        ...
                        .Where(@t => @t.@t.c.Field<string>("CustomerID") == @t.@t.o.Field<string>("CustomerID") && @t.total >= 2000.0M)
                        .Select(@t =>
                            new {
                                CustomerID = @t.@t.c.Field<string>("CustomerID"),
                                OrderID = @t.@t.o.Field<int>("OrderID"),
                                @t.total
                            });
            ...
            public void DataSetLinqLamda18()
            {
                ...
                var myOrders =
                    customers.Where(c => c.Field<string>("Region") == "WA").SelectMany(c => orders, (c, o) => new { c, o })
                    .Where(@t => @t.c.Field<string>("CustomerID") == @t.o.Field<string>("CustomerID") && (DateTime)@t.o["OrderDate"] >= cutoffDate)
                    .Select(@t => new {
                        CustomerID = @t.c.Field<string>("CustomerID"),
                        OrderID = @t.o.Field<int>("OrderID")
                    });
            ...
            public void DataSetLinqLamda19()
            {
